...
class DBUpdater:
        def __init__(self):
                ...
                self.conn = pymysql.connect(host = 'localhost' , user = 'root' , password = 'hide_pass' , db = 'INVESTAR' , charset = 'utf8')
...
"""
        ...
        def replace_into_db(self , df , num , code , company):
                ...
                with self.conn.cursor() as curs:
                        for r in df.itertuples():
                                ...
                                curs.execute(sql)
                        self.conn.commit()
                        print('[{}] #{:04d} {} ({}) : {} lows > REPLACE INTO daily_'\
        ...
        def execute_daily(self):
                ...
                print("Waitig for next update ({}) ...".format(tmnext.strftime('%Y-%m-%d %H:%M')))                
                t.start()
